    ...
    <div class="container">
      <div class="row  align-items-center">
        ...
        <div class="col-xl-5 col-md-8 col-sm-10 col-12 mx-auto ">
          <div class="card h-100 " style="border-radius: 1rem; border-color:gold; border-width:3px;">
            <div class="card-body  " style="background-color: green;border-radius: 1rem;">
              <form>
                ...
                <!-- Email input -->
                <div class="mb-4">
                    <label for="Username" class="fs-4 text-white">Username</label>
                  <input type="text" id="Email" class="form-control form-control-lg" placeholder="Enter Username" />
                </div>
                ...
                <div class="pt-1 mb-4 d-flex justify-content-center">
                    <a href="" class="btn btn-lg btn-warning w-100 px-5">Login</a>
                </div>
                <p class="mb-5 pb-lg-2 justify-content-center" style="color:rgb(255, 255, 255);">Don't have an account? <a href="#!"
